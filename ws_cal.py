...
plt.title ('Promedio anual de velocidad del viento (Jet Stream)\nDatos:Era Interim 1981-2005',fontsize=8,loc = 'left')
plt.savefig('AnnualMeanWS.png',bbox_inches='tight',dpi=150)
plt.close()
...
plt.savefig('WinterMeanWS.png',bbox_inches='tight',dpi=150)
plt.close()
...
cbar = m.colorbar(cs,location='bottom',ticks=clev,size="05%",pad="15%",extend='both',drawedges=True)
cbar.set_label(u'm/s',x=1.05,fontsize=8)
plt.title ('Promedio de velocidad del viento en Verano (Jet Stream)\nDatos:Era Interim 1981-2017',fontsize=8,loc = 'left')
plt.savefig('SummerMeanWS.png',bbox_inches='tight',dpi=150)
plt.close()
...
plt.savefig('AnnualMeanP.png',bbox_inches='tight',dpi=150)
#plt.close()
...
plt.savefig('WinterMeanP.png',bbox_inches='tight',dpi=150)
#plt.close()
...
plt.savefig('SummerMeanP.png',bbox_inches='tight',dpi=150)
#plt.close()
...
plt.savefig('MeanSeries.png',bbox_inches='tight',dpi=150)
#%%
...
recta = 'y='+str(np.round(zi[0],4))+'x'+str(np.round(zi[1],4))
plt.text(2008,1.6,recta,fontsize=8,fontweight='bold')
plt.savefig('LatMeanSeries.png',bbox_inches='tight',dpi=150)
